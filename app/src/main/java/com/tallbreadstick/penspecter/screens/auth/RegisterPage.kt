...
import com.tallbreadstick.penspecter.tools.registerUser
    ...
    Column(
        ...
        Button(
            ...
            onClick = {
                ...
                if (!agree.value) {
                    Toast.makeText(context, "You must agree to the Terms of Service!", Toast.LENGTH_LONG).show()
                    return@Button
                }

                // Perform registration asynchronously
                scope.launch {
                    val registrationResult = registerUser(context!!, username.value, email.value, password.value)
            ...
            Text(text = "Sign Up", fontFamily = Roboto, fontWeight = FontWeight.Bold, fontSize = 20.sp)
        }
        Text(
